...
describe('ConversationTracker', () => {
    ...
    describe('receive', () => {
        it('should collect responses and call onComplete when all agents respond', () => {
            ...
            expect(mockOnComplete).toHaveBeenCalledWith([response2, response1, response3]);
        });
        ...
        it('should handle duplicate responses from same agent', () => {
            ...
            expect(mockOnComplete).toHaveBeenCalledWith([response1, response2, response3]);
        });
        ...
        it('should handle responses from unexpected agents', () => {
            ...
            expect(mockOnComplete).toHaveBeenCalledWith([unexpectedResponse, expectedResponse]);
        });
    ...
    describe('integration', () => {
        it('should handle multiple concurrent conversations', () => {
            ...
            conversationTracker.start(conv1Id, ['agent-1', 'agent-2'], mockOnComplete1);
    ...
    describe('edge cases', () => {
        ...
        it('should handle special characters in agent names', () => {
            ...
            const specialAgentName = 'agent-with-special-chars:!@#$%^&*()_+-=[]{}|;:,.<>?';
